...
const BestSellersSection: React.FC<BestSellersSectionProps> = ({ groupedProducts }) => {
  ...
  const handleProductClick = (product: Product & { _id?: string; productId?: string }) => {
    ...
    navigate(`${PRODUCT_PAGE_URL}/${id}`, { state: { product, sectionTitle: 'Exclusive Buy from Best Sellers', sectionType: 'bestSellers' } });
  };
  ...
  return (
    <Box className={styles.bestSellersSection}>
      ...
      <Typography variant="body2" className={styles.sectionDescription} sx={{ marginBottom: '3%', maxWidth: '60%', marginLeft: '20%' }}>
        ...
        Don't miss out on our hottest picks! These best sellers are flying off the shelves — shop now before they're gone.
        Join the trend and grab your favorites today!
      </Typography>
            ...
            >
              ...
              <Box className={styles.productInfo}>
                ...
                <Box className={styles.priceContainer}>
                  <Typography variant="body1" className={styles.discountedPrice}>
